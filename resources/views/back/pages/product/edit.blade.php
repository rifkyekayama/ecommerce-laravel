				...
				<div class="panel panel-info">
					<div class="panel-wrapper collapse in" aria-expanded="true">
						<div class="panel-body">
							{!! Form::model($product, ['route' => ['admin.products.update', encrypt($product->id)], 'files' => true, 'method' => 'PUT']) !!}
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('name') ? 'has-error has-feedback' : '' }}">
												...
												{{ Form::text('name', $product->name, ['class' => 'form-control', 'placeholder' => 'Nama Produk', 'id' => 'name']) }}
												@if($errors->has('name'))
										...
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('sub_text') ? 'has-error has-feedback' : '' }}">
												...
												{{ Form::text('sub_text', $product->sub_text, ['class' => 'form-control', 'id' => 'sub_text', 'placeholder' => 'Sub Text']) }}
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('brands_id') ? 'has-error has-feedback' : '' }}">
												...
												{!! Form::select('brands_id', $brands, $product->brand->name, ['class' => 'form-control select2', 'placeholder' => 'Pilih', 'id' => 'brands_id']) !!}
										...
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('category_id') ? 'has-error has-feedback' : '' }}">
												...
												{!! Form::select('category_id', $categories, $product->category->name, ['class' => 'form-control select2', 'placeholder' => 'Pilih', 'id' => 'category_id']) !!}
										...
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('original_price') ? 'has-error has-feedback' : '' }}">
												...
												<div class="input-group">
													...
													{!! Form::text('original_price', $product->original_price, ['class' => 'form-control original_price']) !!}
												</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('price') ? 'has-error has-feedback' : '' }}">
												...
												<div class="input-group">
													<div class="input-group-addon">Rp.</div>
													{!! Form::text('price', $product->price, ['class' => 'form-control price']) !!}
												</div>
												@if($errors->has('price'))
									...
									<div class="row">
										<div class="col-md-12 ">
											<div class="form-group {{ $errors->has('desc') ? 'has-error has-feedback' : '' }}">
												{!! Form::textarea('desc', $product->desc, ['class' => 'form-control', 'rows' => 4]) !!}
												@if($errors->has('desc'))
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group {{ $errors->has('meta_keyword') ? 'has-error has-feedback' : '' }}">
												...
												{!! Form::text('meta_keyword', $product->meta_keyword, ['class' => 'form-control']) !!}
			...
			$(document).on('click', '.deletephoto', function(e){
				...
				swal({
					...
					if (isConfirm) {     
						$.ajax({
							type: "DELETE",
							url: "{{ url('admin/photos-product/delete-edit') }}"+"/"+id+"/"+produk,
