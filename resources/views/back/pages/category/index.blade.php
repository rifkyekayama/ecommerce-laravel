...
@section('buttonHead')
	<a href="{{ route('admin.categories.create') }}" class="btn btn-primary pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Create New</a>
@endsection
