...
@section('content')
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="white-box">
				{!! Form::model($brand, ['route' => ['admin.brands.update', encrypt($brand->id)], 'class' => 'form-horizontal', 'files' => true, 'method' => 'PUT']) !!}
					<div class="form-group {{ $errors->has('photo') ? 'has-error has-feedback' : '' }}">
						<label class="col-sm-12">Foto Brand</label>
						<div class="col-sm-12">
							<div class="fileinput fileinput-{{ $brand->photo != null ? 'exists' : 'new' }}" data-provides="fileinput">
					...
					<div class="form-group {{ $errors->has('email') ? 'has-error has-feedback' : '' }}">
						...
						<div class="col-md-12">
							{!! Form::email('email', $brand->email, ['class' => 'form-control', 'placeholder' => 'email']) !!}
							@if($errors->has('email'))
					...
					<div class="form-group {{ $errors->has('contact_name') ? 'has-error has-feedback' : '' }}">
						...
						<div class="col-md-12">
							{!! Form::text('contact_name', $brand->contact_name, ['class' => 'form-control', 'placeholder' => 'Nama Kontak']) !!}
					...
					<div class="form-group {{ $errors->has('phone') ? 'has-error has-feedback' : '' }}">
						...
						<div class="col-md-12">
							{!! Form::text('phone', $brand->phone, ['class' => 'form-control', 'placeholder' => 'Telepon']) !!}
							@if($errors->has('phone'))
					...
					<div class="form-group {{ $errors->has('province_id') ? 'has-error has-feedback' : '' }}">
						...
						<div class="col-md-12">
							<div id="province-container">
								{!! Form::select('province_id', $provinces, $brand->province_id, ['placeholder' => 'Pilih', 'class' => 'form-control select2', 'id' => 'province_id']) !!}
							</div>
					...
					<div class="form-group {{ $errors->has('city_id') ? 'has-error has-feedback' : '' }}">
						...
						<div class="col-md-12">
							<div id="city-container">
								{!! Form::select('city_id', $cities, $brand->city_id, ['placeholder' => 'Pilih', 'class' => 'form-control select2', 'id' => 'city_id']) !!}
							</div>
					...
					<div class="form-group {{ $errors->has('subdistrict_id') ? 'has-error has-feedback' : '' }}">
						...
						<div class="col-md-12">
							<div id="subdistrict-container">
								{!! Form::select('subdistrict_id', $subdistricts, $brand->subdistrict_id, ['placeholder' => 'Pilih', 'class' => 'form-control select2', 'id' => 'subdistrict_id']) !!}
							</div>
					...
					<div class="form-group {{ $errors->has('address') ? 'has-error has-feedback' : '' }}">
						...
						<div class="col-md-12">
							{!! Form::textarea('address', $brand->address, ['class' => 'form-control', 'placeholder' => 'Alamat']) !!}
					...
					<div class="form-group {{ $errors->has('postal_code') ? 'has-error has-feedback' : '' }}">
						...
						<div class="col-md-12">
							{!! Form::text('postal_code', $brand->postal_code, ['class' => 'form-control', 'placeholder' => 'Kode Pos']) !!}
